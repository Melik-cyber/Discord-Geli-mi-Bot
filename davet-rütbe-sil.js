...
exports.run = async (client, message, args) => {
  ...
  if (!rol) {
    const embed = new Discord.MessageEmbed()
      .setDescription(`Lütfen silinecek rütbenin rolünü etiketleyiniz! <a:ReddetmekGif:826398965268217876>`)
      .setColor("RED")
  ...
  if (rol.id === veri) {
    ...
    const embed = new Discord.MessageEmbed()
      .setDescription(
        ...
        }** rolüne sahip rütbe silindi! <a:ModernOnayGif:827470162440617994>`
      )
      .setColor("GREEN")
      .setFooter(client.user.username, client.user.avatarURL);
    message.channel.send(embed);
    ...
    const embed = new Discord.MessageEmbed()
      .setDescription(`Rütbeler arasında böyle bir rütbe bulamadım! <a:ReddetmekGif:826398965268217876>`)
      .setColor("RED")
      .setFooter(client.user.username, client.user.avatarURL);
    message.channel.send(embed);
    return;
