...
.setColor(AloneDogru)
.setTitle("W4ldo | Kuyruğu Temizle")
.setDescription(`<a:equalizer3:833608490114088960>  **| Müzik Kuyruğu, ${message.author} tarafından temizlendi.**`)
...
.setTitle("• Hata: 011 •")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:equalizer3:833608490114088960>   **| Müzik Kuyruğunu temizleyebilmek için bir ses kanalında olmanız gerekmektedir!**`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());
