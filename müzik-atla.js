...
.setDescription(`<a:equalizer3:833608490114088960>     **| Oynatılan bir müziği geçebilmek için bir ses kanalında olmanız gerekmektedir!**`)
...
.setColor(AloneDogru)
.setTitle("Lack Bot | Atla")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:equalizer3:833608490114088960>    **|** \`${sarki.name}\` **adlı müzik** ${message.author} **tarafından geçildi!**`)
