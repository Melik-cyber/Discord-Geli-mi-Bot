...
.setDescription(`<a:equalizer3:833608490114088960>     | Oynatılan bir müziği devam ettirebilmek için bir ses kanalında olmanız gerekmektedir!`)
...
.setColor(AloneDogru)
.setTitle("Lack Bot | Devam Et")
.setDescription(`<a:equalizer3:833608490114088960>    | \`${sarki.name}\` adlı müzik ${message.author} tarafından devam ettirildi!`)
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL())
