...
if (mesaj.length <= 3) {
return message.channel.send(`<:temsilieysi:833583507611189248>   İsim Sistemini Ayarlayabilmek İçin En Az 3 Karakter Belirtebilirsiniz.**\n**__Örnek__**: \`${prefix}isim-sistemi [-uye-]\` ya da \`${prefix}isim-sistemi [-uye-]|[-yas-]\``)
}

db.set(`isimsistemi_${message.guild.id}`, mesaj)
  message.channel.send(`<:temsilieysi:833583507611189248>    **Kayıt Olan Kullanıcıların İsimleri** \`${mesaj}\` Olarak Ayarlanacaktır..`)
};
