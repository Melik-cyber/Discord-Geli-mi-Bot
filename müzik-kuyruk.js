...
.setDescription(`<a:equalizer3:833608490114088960>    | Kuyruğu görüntüleyebilmek için bir ses kanalında olmanız gerekmektedir!`)
...
return `${i === 0 ? '<a:equalizer3:833608490114088960>    | Şu Anda Çalınan Müzik' : `\nKuyruk No: ${i}`} \n**Müziğin Adı:** \`${song.name}\` \n**Müziği Yükleyen Kanal:** \`${song.author}\``
    }).join('\n');
message.channel.send({embed: {color: AloneDogru, title: `W4ldo|  Müzik Kuyruğu`, description: `${q}`}})
}
