...
.setAuthor(`W4ldou Eklenti Menüsü`, client.user.avatarURL())
.setColor('#ffffff')
.setDescription(`<a:dannsss:836860406328197150>   W4ldoumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
.addField(`__Davet Sistemi__`,`<:gelitirici:833583509573861386> »\`${prefix}davetsistemi\` Gelişmiş Davet Sistemi`,true)
.addField(`__Kayıt Sistemi__`,`<:gelitirici:833583509573861386> »\`${prefix}kayıtsistemi\` Gelişmiş Kayıt Sistemi`,true)
