...
.setAuthor(`W4ldo Sayaç Komutları`, client.user.avatarURL())
.setColor('#ffffff')
.setDescription(`<a:dannsss:836860406328197150>  W4ldo botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
.addField(`__Sayaç Ayarla__`,`<a:dannsss:836860406328197150>  » \`${prefix}sayaç-ayarla\` Sunucunuzda Sayacı Ayarlar.`,true)
.addField(`__Oto Cevap Liste__`,`<a:dannsss:836860406328197150>  » \`${prefix}sayaç-hg-mesaj\` Sunucunuzdaki Sayacın Hoş Geldin Mesajını Ayarlar.`,true)
.addField(`__Oto Cevap Sil__`,`<a:dannsss:836860406328197150>  » \`${prefix}sayaç-bb-mesaj\` Sunucunuzdaki Sayacın Görüşürüz Mesajını Ayarlar.`,true)
