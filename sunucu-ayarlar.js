...
const sayfa = [`**${message.guild.name} | Sunucu Ayarları**\n**Botun Prefixi :** \`${p}\n**Reklam Engel:** ${db.fetch(`reklamengel_${message.guild.id}`) ? `<:online:833583502146142229> ` : `<a:rahatszite:833583509289435146> ` }\n**Küfür Engel:** ${db.fetch(`kufurE_${message.guild.id}`) ? `<:online:833583502146142229>  ` : `<a:rahatszite:833583509289435146>` }`]
