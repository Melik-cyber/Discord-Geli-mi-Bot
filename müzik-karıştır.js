...
.setColor(AloneDogru)
.setTitle("W4ldo |  Karıştır")
.setDescription(`a:equalizer3:833608490114088960>   | Müzik Kuyruğu, ${message.author} tarafından karıştırıldı.`)
...
.setTitle("• Hata: 009 •")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:equalizer3:833608490114088960>    | Müzik kuyruğunu karıştırabilmek için bir ses kanalında olmanız gerekmektedir!`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());
